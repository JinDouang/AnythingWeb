...
import {ComponentSideBarComponent} from './component-side-bar.component';
import {RouterModule} from '@angular/router';

export const MODULE_PROVIDERS: Provider[] = [
];

export const MODULE_DECLARATIONS: Array<Type<any> | any[]> = [ComponentSideBarComponent];

export const MODULE_IMPORTS: Array<Type<any> | ModuleWithProviders | any[]> = [
  CommonModule,
  RouterModule,
];
export const MODULE_EXPORTS: Array<Type<any> | any[]> = [ComponentSideBarComponent];
